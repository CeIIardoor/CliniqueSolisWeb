(function webpackUniversalModuleDefinition(root, factory) {
  ...
  return /******/ (function () {
    ...
    /******/ var __webpack_modules__ = {
      /***/ 482: /***/ function (
        ...
        /* harmony import */ var _lib_event_js__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(698);
        /* harmony import */ var _lib_date_format_js__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(963);
        /* harmony import */ var _Datepicker_js__WEBPACK_IMPORTED_MODULE_2__ =
        ...
        function setupDatepicker(rangepicker, changeDateListener, el, options) {
          (0,
          _lib_event_js__WEBPACK_IMPORTED_MODULE_0__ /* .registerListeners */.cF)(
            rangepicker,
            [[el, 'changeDate', changeDateListener]]
          );
          new _Datepicker_js__WEBPACK_IMPORTED_MODULE_2__ /* ["default"] */.Z(
            el,
            options,
            rangepicker
          );
        ...
        class DateRangePicker {
          ...
          destroy() {
            ...
            (0,
            _lib_event_js__WEBPACK_IMPORTED_MODULE_0__ /* .unregisterListeners */.uV)(
              this
            );
          ...
          getDates(format = undefined) {
            const callback = format
              ? (date) =>
                  (0,
                  _lib_date_format_js__WEBPACK_IMPORTED_MODULE_1__ /* .formatDate */.p6)(
                    date,
                    format,
      ...
      /***/ 770: /***/ function (
        ...
        var lib_event = __webpack_require__(698); // CONCATENATED MODULE: ./node_modules/flowbite-datepicker/js/i18n/base-locales.js
        // default locales
        const locales = {
          en: {
            days: [
        ...
        /* harmony default export */ var options_defaultOptions =
          defaultOptions; // CONCATENATED MODULE: ./node_modules/flowbite-datepicker/js/lib/dom.js
        ...
        function validateDate(value, format, locale, origValue) {
          const date = (0, date_format /* parseDate */.sG)(
            value,
            format,
            locale
          );
        ...
        function processOptions(options, datepicker) {
          ...
          if (inOpts.format) {
            ...
            const validFormatString =
              date_format /* reFormatTokens.test */.CL.test(inOpts.format);
          ...
          if (inOpts.datesDisabled) {
            config.datesDisabled = inOpts.datesDisabled.reduce((dates, dt) => {
              ...
              return date !== undefined
                ? (0, utils /* pushUnique */.$C)(dates, date)
                : dates;
            }, []);
            delete inOpts.datesDisabled;
          }
          if (inOpts.defaultViewDate !== undefined) {
            const viewDate = (0, date_format /* parseDate */.sG)(
          ...
          if (inOpts.orientation) {
            ...
            config.orientation = {
              x:
                orientation.find((x) => x === 'left' || x === 'right') ||
                'auto',
              y:
                orientation.find((y) => y === 'top' || y === 'bottom') ||
                'auto',
            };
          ...
          Object.keys(inOpts).forEach((key) => {
            if (
              inOpts[key] !== undefined &&
              (0, utils /* hasProperty */.l$)(options_defaultOptions, key)
            ) {
        ...
        const pickerTemplate = (0,
        utils /* optimizeTemplateHTML */.zh)(`<div class="datepicker hidden">
  <div class="datepicker-picker inline-block rounded-lg bg-white dark:bg-gray-700 shadow-lg p-4">
    ...
    <div class="datepicker-footer">
      <div class="datepicker-controls flex space-x-2 mt-2">
        ...
        /* harmony default export */ var templates_pickerTemplate =
          pickerTemplate; // CONCATENATED MODULE: ./node_modules/flowbite-datepicker/js/picker/templates/daysTemplate.js

        const daysTemplate = (0,
        utils /* optimizeTemplateHTML */.zh)(`<div class="days">
  <div class="days-of-week grid grid-cols-7 mb-1">${(0,
  utils /* createTagRepeat */.em)('span', 7, {
    class:
  ...
  utils /* createTagRepeat */.em)('span', 42, {
    class:
      'block flex-1 leading-9 border-0 rounded-lg cursor-default text-center text-gray-900 font-semibold text-sm h-6 leading-6 text-sm font-medium text-gray-500 dark:text-gray-400',
        ...
        /* harmony default export */ var templates_daysTemplate = daysTemplate; // CONCATENATED MODULE: ./node_modules/flowbite-datepicker/js/picker/templates/calendarWeeksTemplate.js

        const calendarWeeksTemplate = (0,
        utils /* optimizeTemplateHTML */.zh)(`<div class="calendar-weeks">
  <div class="days-of-week flex"><span class="dow h-6 leading-6 text-sm font-medium text-gray-500 dark:text-gray-400"></span></div>
  <div class="weeks">${(0, utils /* createTagRepeat */.em)('span', 6, {
    class:
      'week block flex-1 leading-9 border-0 rounded-lg cursor-default text-center text-gray-900 font-semibold text-sm',
  })}</div>
</div>`);

        /* harmony default export */ var templates_calendarWeeksTemplate =
          calendarWeeksTemplate; // CONCATENATED MODULE: ./node_modules/flowbite-datepicker/js/picker/views/View.js
        ...
        class DaysView extends View {
            ...
            if (options.calendarWeeks !== undefined) {
              if (options.calendarWeeks && !this.calendarWeeks) {
                const weeksElem = parseHTML(
                  templates_calendarWeeksTemplate
                ).firstChild;
                this.calendarWeeks = {
                  element: weeksElem,
          ...
          updateFocus() {
            ...
            const firstOfMonth = (0, lib_date /* dateValue */.by)(
              viewYear,
              viewMonth,
              1
            );
            const start = (0, lib_date /* dayOfTheWeekOf */.fr)(
              firstOfMonth,
              this.weekStart,
              this.weekStart
            );
            ...
            this.last = (0, lib_date /* dateValue */.by)(
              viewYear,
              viewMonth + 1,
              0
            );
          ...
          render() {
            ...
            const switchLabel = (0, date_format /* formatDate */.p6)(
              this.focused,
            ...
            if (this.calendarWeeks) {
              ...
              const startOfWeek = (0, lib_date /* dayOfTheWeekOf */.fr)(
                this.first,
                1,
                1
              );
              Array.from(this.calendarWeeks.weeks.children).forEach(
                (el, index) => {
                  el.textContent = (0, lib_date /* getWeek */.Qk)(
                    (0, lib_date /* addWeeks */.jh)(startOfWeek, index)
                  );
                }
              );
            }
        ...
        class MonthsView extends View {
          ...
          init(options, onConstruction = true) {
            if (onConstruction) {
              ...
              this.grid.appendChild(
                parseHTML(
                  (0, utils /* createTagRepeat */.em)('span', 12, {
                    'data-month': (ix) => ix,
                  })
                )
              );
          ...
          setOptions(options) {
            ...
            if ((0, utils /* hasProperty */.l$)(options, 'maxDate')) {
              if (options.maxDate === undefined) {
                ...
                this.maxDate = (0, lib_date /* dateValue */.by)(
                  this.maxYear,
                  this.maxMonth + 1,
                  0
                );
          ...
          render() {
            ...
            Array.from(this.grid.children).forEach((el, index) => {
              const classList = el.classList;
              const date = (0, lib_date /* dateValue */.by)(
                this.year,
                index,
                1
              );
        ...
        class YearsView extends View {
          ...
          init(options, onConstruction = true) {
            if (onConstruction) {
              ...
              this.grid.appendChild(
                parseHTML((0, utils /* createTagRepeat */.em)('span', 12))
              );
            }
            super.init(options);
          }
          ...
          setOptions(options) {
            if ((0, utils /* hasProperty */.l$)(options, 'minDate')) {
              if (options.minDate === undefined) {
                ...
                this.minYear = (0, lib_date /* startOfYearPeriod */.ak)(
                  options.minDate,
                  this.step
                );
                this.minDate = (0, lib_date /* dateValue */.by)(
                  this.minYear,
                  0,
                  1
                );
            ...
            if ((0, utils /* hasProperty */.l$)(options, 'maxDate')) {
              if (options.maxDate === undefined) {
                ...
                this.maxYear = (0, lib_date /* startOfYearPeriod */.ak)(
                  options.maxDate,
                  this.step
                );
                this.maxDate = (0, lib_date /* dateValue */.by)(
          ...
          updateFocus() {
            const viewDate = new Date(this.picker.viewDate);
            const first = (0, lib_date /* startOfYearPeriod */.ak)(
              viewDate,
              this.navStep
            );
            ...
            this.focused = (0, lib_date /* startOfYearPeriod */.ak)(
              viewDate,
              this.step
            );
          }
          ...
          updateSelection() {
            ...
            this.selected = dates.reduce((years, timeValue) => {
              return (0, utils /* pushUnique */.$C)(
                years,
                (0, lib_date /* startOfYearPeriod */.ak)(timeValue, this.step)
              );
            }, []);
            if (rangepicker && rangepicker.dates) {
              this.range = rangepicker.dates.map((timeValue) => {
                if (timeValue !== undefined) {
                  return (0, lib_date /* startOfYearPeriod */.ak)(
                    timeValue,
                    this.step
                  );
                }
        ...
        function goToPrevOrNext(datepicker, direction) {
          ...
          switch (currentView.id) {
            case 0:
              newViewDate = (0, lib_date /* addMonths */.zI)(
                viewDate,
                direction
              );
              break;
            case 1:
              newViewDate = (0, lib_date /* addYears */.Bc)(
                viewDate,
                direction
              );
              break;
          ...
          newViewDate = (0, utils /* limitToRange */.jG)(
            newViewDate,
            minDate,
            maxDate
          );
        ...
        function goToSelectedMonthOrYear(datepicker, selection) {
          ...
          const newDate =
            viewId === 1
              ? (0, lib_date /* addMonths */.zI)(
                  viewDate,
                  selection - viewDate.getMonth()
                )
              : (0, lib_date /* addYears */.Bc)(
                  viewDate,
        ...
        function onClickView(datepicker, ev) {
          const target = (0, lib_event /* findElementInEventPath */.He)(
            ev,
            '.datepicker-cell'
          );
        ...
        function processPickerOptions(picker, options) {
          ...
          if (
            (0, utils /* hasProperty */.l$)(options, 'minDate') ||
            (0, utils /* hasProperty */.l$)(options, 'maxDate')
          ) {
            const { minDate, maxDate } = picker.datepicker.config;
            picker.controls.todayBtn.disabled = !(0, utils /* isInRange */.mh)(
              (0, lib_date /* today */.Lg)(),
              minDate,
              maxDate
            );
        ...
        function computeResetViewDate(datepicker) {
          ...
          const viewDate =
            dates.length > 0
              ? (0, utils /* lastItemOf */.Jm)(dates)
              : config.defaultViewDate;
          return (0, utils /* limitToRange */.jG)(
            viewDate,
            config.minDate,
            config.maxDate
          );
        ...
        class Picker {
          ...
          show() {
            ...
            if (!datepicker.inline) {
              ...
              if (
                inputDirection !== getTextDirection(datepicker.config.container)
              ) {
          ...
          place() {
            ...
            if (orientX === 'auto') {
              if (left < 0) {
                ...
                orientX =
                  getTextDirection(inputField) === 'rtl' ? 'right' : 'left';
              }
            }
            if (orientX === 'right') {
        ...
        function moveByArrowKey(datepicker, ev, direction, vertical) {
          ...
          switch (currentView.id) {
            case 0:
              if (vertical) {
                viewDate = (0, lib_date /* addDays */.E4)(
                  viewDate,
                  direction * 7
                );
              ...
              break;
            case 1:
              viewDate = (0, lib_date /* addMonths */.zI)(
                viewDate,
              ...
              break;
            default:
              viewDate = (0, lib_date /* addYears */.Bc)(
                viewDate,
                direction * (vertical ? 4 : 1) * step
              );
              addFn = lib_date /* addYears */.Bc;
              testFn = (date) =>
                currentView.disabled.includes(
                  (0, lib_date /* startOfYearPeriod */.ak)(date, step)
                );
          }
        ...
        function onClickOutside(datepicker, ev) {
          ...
          if (
            (0, lib_event /* findElementInEventPath */.He)(
              ev,
        ...
        function processInputDates(datepicker, inputDates, clear = false) {
          ...
          const rangeEnd =
            rangepicker && datepicker === rangepicker.datepickers[1];
          let newDates = inputDates.reduce((dates, dt) => {
            let date = (0, date_format /* parseDate */.sG)(
              dt,
              config.format,
              config.locale
            );
        ...
        class Datepicker {
          ...
          constructor(element, options = {}, rangepicker = undefined) {
            ...
            if (inline) {
              ...
              initialDates = (0, utils /* stringToArray */.W7)(
          ...
          static formatDate(date, format, lang) {
            return (0, date_format /* formatDate */.p6)(
              date,
              format,
          ...
          static parseDate(dateStr, format, lang) {
            return (0, date_format /* parseDate */.sG)(
              dateStr,
              format,
              (lang && locales[lang]) || locales.en
            );
          ...
          update(options = undefined) {
            ...
            const inputDates = (0, utils /* stringToArray */.W7)(
      ...
      /***/ 963: /***/ function (
        ...
        /* harmony import */ var _date_js__WEBPACK_IMPORTED_MODULE_0__ =
        ...
        function parseFormatString(format) {
          ...
          return (knownFormats[format] = {
            ...
            formatter(date, locale) {
              ...
              return (dateStr += (0,
              _utils_js__WEBPACK_IMPORTED_MODULE_1__ /* .lastItemOf */.Jm)(
                separators
              ));
            },
          });
        ...
        function parseDate(dateStr, format, locale) {
          if (dateStr instanceof Date || typeof dateStr === 'number') {
            const date = (0,
            _date_js__WEBPACK_IMPORTED_MODULE_0__ /* .stripTime */.xR)(dateStr);
          ...
          if (format && format.toValue) {
            ...
            return isNaN(date)
              ? undefined
              : (0, _date_js__WEBPACK_IMPORTED_MODULE_0__ /* .stripTime */.xR)(
                  date
                );
          }
    ...
    !(function () {
      ...
      /* harmony import */ var flowbite_datepicker_Datepicker__WEBPACK_IMPORTED_MODULE_0__ =
        __webpack_require__(770);
      /* harmony import */ var flowbite_datepicker_DateRangePicker__WEBPACK_IMPORTED_MODULE_1__ =
        __webpack_require__(482);
      /* harmony import */ var _dom_events__WEBPACK_IMPORTED_MODULE_2__ =
      ...
      function initDatepickers() {
        document
          ...
          .forEach(function (datepickerEl) {
            new flowbite_datepicker_Datepicker__WEBPACK_IMPORTED_MODULE_0__ /* ["default"] */.Z(
              datepickerEl,
        ...
        document
          ...
          .forEach(function (datepickerEl) {
            new flowbite_datepicker_DateRangePicker__WEBPACK_IMPORTED_MODULE_1__ /* ["default"] */.Z(
              datepickerEl,
              getDatepickerOptions(datepickerEl)
            );
          });
      }
      var events = new _dom_events__WEBPACK_IMPORTED_MODULE_2__['default'](
        'DOMContentLoaded',
        [initDatepickers]
      );
      events.init();
